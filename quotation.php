...
<div class=container id="home">
    <div class="row" style="background-color: #101D25">
        <div class="col-md-6" style="margin-top: 25px">
            <span style="font-size:30px;cursor:pointer;color:#FFA500" onclick="openNav()">&#9776; <img src="./assets/img/Logo 1.png" alt="logo" style="width:20%;height:80%;float: right;"><b>Quotation</b></span>
        </div>
        <div class="col-md-6">
      ...
      $sql="SELECT * from billing where `type`!='bill' and  `user_id`=".$user_id;
      $query=mysqli_query($con,$sql);
      while ($info=mysqli_fetch_array($query)) {
        ?>
            <div class="card-body">
              <h4 style = "color:#101D25;"><b><?php echo $info['path'];?></b></h4>
              <button class="btn"><i class="fa fa-download"></i><a href="https://vcare.viswatechnologysolutions.com/taxi/upload/<?php echo $info['path']; ?>" download target="_blank">Download</a></button>
             </div>
        </a>
        <?php
      }
