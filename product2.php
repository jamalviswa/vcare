        ...
        <div>
            <div style="color:#000;font-family:auto;">
                ...
                if(!empty($_REQUEST['pid'])){
                    ...
                    <p style="background-color:#101D25;border-radius:20px;margin:auto;margin-top:10px;margin-bottom:10px;color:#FFA500;padding:10px;font-size:20px;width:100px;"><b><?php echo $jows['hargaeceran']; ?></b></p>
                    <p><b>Description : </b><ul><li><?php echo $jows['deskripsi']; ?></li></ul><br></p>
                    <?php
                }
                ?>
