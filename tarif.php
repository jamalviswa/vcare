...
<div style="color:#fff;margin-top:20px;font-size:15px;font-weight:bold;font-family:Segoe UI light;float:right;padding-right:20px;">Your Route
</div></div></div>
...
?>
<center style="color:#444"><small>Driving route</small>
</center><br>
<iframe style="z-index:9999"width="100%" height="400" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/directions?origin=<?php echo $_POST["asal"]; ?>&amp;destination=<?php echo $_POST['lat']?>,<?php echo $_POST['lng']?>&amp;key=AIzaSyAteo77fhOppaMLuJxZ1dggEd5qHuiyhSU" allowfullscreen="no"></iframe>
...
//OSRM
//$urlApi = "http://router.project-osrm.org/route/v1/driving/".$latfrom.",".$lngfrom.";".$lat.",".$lng."?overview=false";
//$askjh = file_get_contents($urlApi);
//$data   = json_decode($askjh, true);
//$eks = $data['routes'][0]['distance'];
//OSRM END
$yipe=$_POST['tipe'];
if($yipe=='motorcycle')
      {
...
if($yipe=='car')
      {
$tarif= $vision['transportasimobil'];
      } 
