...
$koint=$pointawal-10;
$result = mysqli_query($mysqli, "UPDATE users set point='$koint' where id='$id'");
$result = mysqli_query($mysqli, "UPDATE transaksi set tipebayar='point', status_trans='otw' where id_trans='$id_trans'");
