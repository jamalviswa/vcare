...
<style type="text/css">.input-controls{margin-top:5px;border:1px solid transparent;border-radius:2px 0 0 2px;box-sizing:border-box;-moz-box-sizing:border-box;background:#fff;height:32px;outline:0;box-shadow:0 2px 6px rgba(0,0,0,0.3)}#searchInput{background:#fff;font-family:Roboto;font-size:15px;font-weight:300;margin-left:12px;padding:0 11px 0 13px;text-overflow:ellipsis}#searchInput:focus{border-color:#4d90fe}</style><script type="text/javascript"src="https://maps.googleapis.com/maps/api/js?sensor=true&key=AIzaSyCyFYixcrWBGhOug-EghJr08S5n2GxtFDA&v=3.exp&libraries=places&callback=initMap"></script>
<input style="background:#fff;z-index:9;position:absolute;margin-left:0px;top:0;width:100%;border-bottom:3px solid #09c;height:60px" id="searchInput" class="input-controls" type="text" placeholder="Input Address name, City">
