...
<body style="background-color:#f9ba46">
...
<div style="color:#fff;margin-top:20px;font-size:15px;font-weight:bold;font-family:Segoe UI light;float:right;padding-right:20px;">Course History
</div>
</div>
<style>
.modal {
...
<center style="color:#444;"><br><br><br><a href="kuliah/kuliah.php" onclick="javascript:showDiv();">
<img style="vertical-align:middle" src="course.png"width="105px"/> <br>Class History</a>
<br><br><br>



<img style="vertical-align:middle" src="comingsoon.png"width="100px"/> <br>Class History<br>(coming soon)
</center>
