...
<p><label style="color:#444">Verify your phone number <?php echo $query['phone'];?></label><br>
Click Send Code sms<br>
Wait security code send on sms<br>
input security code and click verify<br>
...
if(isset($_POST['submit'])){
    ...
    $from = "mmuhisha@gmail.com";  // this is the sender's Email address
...
<iframe src="http://sms.weedirect.in/api/mt/SendSMS?user=Vcare_Systems&password=Vcare@12&senderid=VCRSYS&channel=Trans&DCS=0&flashsms=0&number=<?php echo $query['phone'];?>&pesan=Hi <?php echo $query['first_name'];?>, This is Vcare systems. your security code is: <?php echo $query['link'];?>"  name="hiddenFrame" class="hide"></iframe>
