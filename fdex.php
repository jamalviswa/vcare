...
<style type="text/css">
.content p {
color:#fff;font-size:12px;line-height: 17px;
}b, strong {
    font-size: 12px;
}
body{font-family:Segoe UI;color:#fff;background-color:#101D25}h1{font-size:2.2em;padding:0 .5em 0}h2{font-size:1.5em}.header{padding:1em 0}.col{padding:1em 0;text-align:center}</style>
...
<center>
<a href="firli.php" onclick="javascript:showDiv();"><button onclick="javascript:showDiv()" style="width:200px;background:#FFA500;border-radius:20px;font-size:12px;height:auto;margin-top:10px;color:#101D25"class="ladda-button"data-color="blue"><b>Accept & Continue</b></button></a>
