...
$result = mysqli_query($mysqli, "UPDATE transaksi set status_trans='cancel', online='read', aktif='no', beritaacara='canceled by client' WHERE id_trans=$id_trans and status_trans='dijemput'");
