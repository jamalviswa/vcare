...
<div class=container id="home">
    <div class="row" style="background-color: #101D25">
        <div class="col-md-6" style="margin-top: 25px">
            <span style="font-size:30px;cursor:pointer;color:#FFA500" onclick="openNav()">&#9776; <img src="./assets/img/Logo 1.png" alt="logo" style="width:20%;height:80%;float: right;"><b>Billing</b></span>
        </div>
        <div class="col-md-6">
      ...
      while ($info=mysqli_fetch_array($query)) {
        ?>
        <a href="upload/<?php echo $info['path'] ; ?>">
      <embed type="application/pdf" src="upload/<?php echo $info['path'] ; ?>" width="375" height="812">
        </a>
        <?php
      }
