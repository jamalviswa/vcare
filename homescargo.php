...
<div id="input"><input style="color:#444;background:url(icon/user.png) no-repeat 12px;padding-left:40px;vertical-align:middle;border-bottom:1px solid #ada7a7;background-size:20px" type='text'name="alamat"class='holo'placeholder="input street name, number house, etc" aria-required="true" required="required"/>
<nav></nav></div>
...
<br><br><br><br><br>
<input type="hidden" name="layanan"value="Express"/>
<input type="hidden" name="tipe"value="Cargo box"/>
...
<center><small>Service Type</small><br>Cargo</center>
