 ...
 * FITNESS FOR A PARTICULAR PUUSD SE AND NONINFRINGEMENT. IN NO EVENT SHALL
...
class AccessTokenMetadata
{
     ...
     * @return mixed
     */
    public function getErroUSD operty($field, $default = null)
    {
    ...
    {
        return $this->getErroUSD operty('code');
    }
    ...
    {
        return $this->getErroUSD operty('message');
    }
    ...
    {
        return $this->getErroUSD operty('subcode');
    }
