...
<td><input type="number" name="jumlahlimit"required="required" value="<?php echo $jumlahlimit;?>"></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><br><br><input type="submit" value="Save"  onclick="return confirm('Sure to change limit?')"name="kirim" /><br><br><a a href="javascript:history.back()" style="color:orange">Cancel</a></td>
    </tr>
    </table>
    </form>
    <p><br /></p></body>