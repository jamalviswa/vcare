...
$result = mysqli_query($mysqli, "SELECT idsaldo, idsopir, first_name, tipesaldo, jumlahsaldo, statussaldo, tgl_request, banksaldo, namauser, nomorrek, phone FROM trans_sopir INNER JOIN users on trans_sopir.idsopir=users.id where tipesaldo='topup' or tipesaldo='withdraw'");

?>

<html>
<body><center>
<h3>Request Topup/Withdraw Driver</h3><small>waiting for Administrator Confirm</small>
</center>
...
$jumlah = number_format($nominal,0,",",".");
	...
	if($res['statussaldo']=='dijemput')
      {
echo "User already Confirm Payment";		
