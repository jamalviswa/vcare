...
$jirname = "../fotobarang/". $_FILES['file']['name'];

$filename1 = "../fotobarang/small". $_FILES['file']['name'];
...
//If no errors registred, print the success message
 if(isset($_POST['Submit']) && !$errors) 
 {
	...
	$query=mysqli_query($mysqli, "update jw_product set product_image_ori='$filename1' where product_id='$product_id'");
 if($query){
		?>
...
<center>Upload Foto Menu Makanan</center>
</table>
...
<input type="hidden" name="product_id" value="<?php echo $query['product_id']; ?>"/>
