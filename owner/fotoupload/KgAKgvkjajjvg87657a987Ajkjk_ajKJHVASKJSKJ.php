...
<b>Data PeUSD njangan STNK</b><br>
<table>
...
<center>
<p style="color:"><label>Upload Foto STNK dan KTP anda dalam satu Gambar<br>(difoto secara bersamaan, pastikan tulisan terlihat semua)</label></p>
...
<div style="padding:10px;color:#565656;border:1px solid #565656; border-style: dashed;">
<input type="file" accept="image/*" name="user_attach" id="fileInput" size="999999"/>
</div>
<br><br>
