...
<center>Police Button alert !!!!<br> Call police</center><br>
<?php 
...
<b><small>Emergency status from <?php echo $paka["first_name"]; ?></small></b><br>
<table style="width:100%">
<tr style="font-size:12px;color:#565656"><td>Invoice</td><td>:</td><td width="50%"> <?php echo $paka['kode_trans']; ?></td></tr>
...
<tr style="font-size:12px;color:#565656"><td>Price</td><td>:</td><td width="50%"> USD <?php 
$jika = $paka['harga'];
$toto = number_format($jika,0,",",".");
echo $toto;?></td></tr>
<tr style="font-size:12px;color:#565656"><td>Adress</td><td>:</td><td width="50%"> <?php echo $paka["alamat"]; ?></td></tr>
<tr style="font-size:12px;color:#565656"><td>Destination</td><td>:</td><td width="50%"> <?php echo $paka["tujuan"]; ?></td></tr>
