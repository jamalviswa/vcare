		...
		<div class="table-responsive" style="padding:20px">
				<br /><div align="left">
					<a href="../../survey.php"><button style="font-size:12px;font-weight:bold"type="button" class="btn btn-info btn-lg">Kembali</button></a>
				</div>
				<div align="right">
...
$(document).ready(function(){
	$('#add_button').click(function(){
		$('#user_form')[0].reset();
		$('.modal-title').text("Tambah Data kategori SmartPustaka");
		$('#action').val("Add");
		$('#operation').val("Add");
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('.modal-title').text("Ubah Data kategori Smartpustaka");
				$('#id').val(id);
