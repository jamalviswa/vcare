...
<b> USD  <?php
$query = "SELECT sum(harga) AS total FROM transaksi where status_trans='otw' or status_trans='finish' and YEAR(tanggal) = YEAR(NOW( )) AND MONTH(tanggal) = MONTH(NOW( ))"; 
...
<br />
<div class="container" style="background-color:#fff;"><br><br><center><h4 style="color: #6f6f6f;">Grafik Transaksi</h4>
			<!-- Codrops top bar -->
		<div class="section group">
<br>
	<div class="col span_2_of_2">

	Grafik Penghasilan pada <?php echo date('M'); ?> - <?php echo date('Y'); ?>
<br>
	<?php
include_once '../dbconnect.php';
