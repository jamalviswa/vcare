...
<th style="background:#fff;color:#101D25;"><b>image name</b></th>
<th style="background:#fff;color:#101D25;"><b>Image</b></th>
	...
	$res1=mysqli_query($mysqli, "SELECT * FROM imagestore");
    $count = 0;
	while($res = mysqli_fetch_array($res1)) { 	
     $count ++; 
		...
		echo  "<td>"."$count". "</td>";
			echo "<td>".$res['name']."</td>";
		echo "<td>";?>
		<img width="100px" src="../imagephoto/<?php echo $res['image'];?>"> </img></a>
		<?php echo "</td>";
