			...
			loadScript(plugin_path + 'slider.flexslider/jquery.flexslider-min.js', function() {
				...
				if(jQuery().flexslider) {
					var	_controlNav 	= _container.attr('data-controlNav'),
						_slideshowSpeed = _container.attr('data-slideshowSpeed') || ,
					...
					jQuery(_container).flexslider({
						...
						slideshowSpeed	: parseInt(_slideshowSpeed) || ,
	...
	function _wrotate() {
		jQuery(".word-rotator").each(function() {
			...
			var _t 				= jQuery(this),
				...
				_cItem 			= 1,
				_cTop 			= 0,
				_delay 			= jQuery(this).attr('data-delay') || ;
			...
			loadScript(plugin_path + 'toastr/toastr.js', function() {
				...
				_btn.bind("click", function(e) {
					...
					var _message 			= jQuery(this).attr('data-message'),
						...
						_hideDuration 		= jQuery(this).attr('data-hideDuration') 		|| "",
						_timeOut 			= jQuery(this).attr('data-timeOut') 			|| "",
						_extendedTimeOut	= jQuery(this).attr('data-extendedTimeOut')		|| "",
 ...
 **************************************************************** **/
	function _pickers() {
		...
		/** Color Picker
		 ******************* **/
		var _container_4 = jQuery('.coloUSD cker');
					...
					_container_4.each(function() {
						var _t 					= jQuery(this),
							...
							if(_palletteOnly == "true" || _fullPicker == "true") {
								...
								var _palette = [
										["","#444","#666","#999","#ccc","#eee","#f3f3f3","#fff"],
										["#f00","#f90","#ff0","#0f0","#0ff","#00f","#90f","#f0f"],
										["#f4cccc","#fce5cd","#fff2cc","#d9ead3","#d0e0e3","#cfe2f3","#d9d2e9","#ead1dc"],
										["#ea9999","#f9cb9c","#ffe599","#b6d7a8","#a2c4c9","#9fc5e8","#b4a7d6","#d5a6bd"],
										["#e06666","#f6b26b","#ffd966","#93c47d","#76a5af","#6fa8dc","#8e7cc3","#c27ba0"],
										["#c00","#e69138","#f1c232","#6aa84f","#45818e","#3d85c6","#674ea7","#a64d79"],
										["#900","#b45f06","#bf","#38761d","#134f5c","#0b5394","#351c75","#741b47"],
										["#600","#783f04","#7f","#274e13","#0c343d","#073763","#20124d","#4c1130"]
									];
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path + 'pajinate/jquery.pajinate.bootstrap.min.js', function() {
				...
				if(jQuery().pajinate) {
					...
					_container.each(function() {
						var _t 			= jQuery(this),
							_peUSD ge 	= _t.attr('data-pajinante-items-per-page') 	|| 8;
							_numLinks 	= _t.attr('data-pajinante-num-links') 		|| 5;

						_t.pajinate({
							items_per_page 				: parseInt(_peUSD ge),
...
/** Modal Autoload
	...
	<div id="MODAL-ID-REQUIRED" class="modal fade" data-autoload="true" data-autoload-delay="">
		...
	</div>
 **************************************************************** **/
			...
			jQuery("div.modal").each(function() {
				...
				if(_autostart == 'true') {
					...
					jQuery(window).load(function() { // required on load!
						var _delay = _t.attr('data-autoload-delay') || ; // delay when modal apprear
 ...
 **************************************************************** **/
	...
	function relative_time(time_value) {
		var values 		= time_value.split(" "),
			...
			delta 		= parseInt((relative_to.getTime() - parsed_date) / );
 ...
 **************************************************************** **/
 (function ($) {
	...
	$.fn.countTo.defaults = {
		...
		speed: ,           // how long it should take to count between the target numbers
