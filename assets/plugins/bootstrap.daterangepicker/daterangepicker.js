...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DUSD emplate = '<div class="daterangepicker dropdown-menu">' +
        ...
        this.container = $(DUSD emplate).appendTo(this.parentEl);
    ...
    DateRangePicker.prototype = {
        ...
        outsideClick: function (e) {
            var target = $(e.target);
            // if the page is clicked anywhere except within the daterangeUSD cker/button
