				...
				var defaults = {
					...
					return this.each(function() {
						...
						if (options.simplifyAll=="on") {
							...
							punchgs.TweenLite.lagSmoothing(,16);
							punchgs.force3D = "true";
						}
		...
		*******************************************/
		...
		function initSlider(container,opt) {
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									if (container.attr('id')==undefined) container.attr('id',"revslider-"+Math.round(Math.random()*+5));
									...
									if (opt.parallax!="off") checkFoUSD rallax(container,opt);
			...
			*/
			...
			if (nexttrans==1) {
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.TweenLite.from(ss,rand/,
										{autoAlpha:0, force3D:"auto",rotation:opt.rotate,ease:punchgs.Power2.easeInOut}),rand2/);
						});
			}
			...
			if (nexttrans==2) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.TweenLite.to(ss,masterspeed/,{left:opt.slotw, force3D:"auto",rotation:(0-opt.rotate)}),0);
							mtl.add(subtl,0);
						});
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.TweenLite.from(ss,masterspeed/,{left:0-opt.slotw, force3D:"auto",rotation:opt.rotate}),0);
							mtl.add(subtl,0);
						});
			}
			...
			if (nexttrans==3) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.TweenLite.to(ss,masterspeed/,{top:opt.sloth,rotation:opt.rotate,force3D:"auto",transformPerspective:600}),0);
							mtl.add(subtl,0);
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.TweenLite.from(ss,masterspeed/,{top:0-opt.sloth,rotation:opt.rotate,ease:punchgs.Power2.easeOut,force3D:"auto",transformPerspective:600}),0);
							mtl.add(subtl,0);
						});
			}
			...
			if (nexttrans==6) {
						...
						actsh.find('.slotslide').each(function(i) {
							...
							subtl.add(punchgs.TweenLite.to(ss,(masterspeed+tempo)/,{top:0+opt.height,opacity:1,force3D:"auto",rotation:opt.rotate,ease:punchgs.Power2.easeInOut}),0);
							mtl.add(subtl,0);
						});
			...
			if (nexttrans==9 || nexttrans==10) {
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,{autoAlpha:0,force3D:"auto",transformPerspective:600},
																				 {autoAlpha:1,ease:punchgs.Power2.easeInOut,delay:(i*5)/}),0);
			...
			if (nexttrans==11 || nexttrans==26) {
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							mtl.add(punchgs.TweenLite.from(ss,masterspeed/,{autoAlpha:0,force3D:"auto",ease:punchgs.Power2.easeInOut}),0);
						});
			}
			...
			if (nexttrans==19 || nexttrans==22) {								// IN CUBE
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
											...
											{left:0,rotationY:0,top:0,z:0, scale:1,force3D:"auto",rotationX:0, delay:(j*50)/,ease:punchgs.Power2.easeInOut}),0);
						...
						actsh.find('.slotslide').each(function(j) {
							...
							subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
											...
											{autoAlpha:1,rotationY:opt.rotate,top:0,z:10, scale:1,rotationX:rot, delay:(j*50)/,force3D:"auto",ease:punchgs.Power2.easeInOut}),0);
			...
			if (nexttrans==20 ) {								// FLYIN
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/1500,
											...
											{left:0, delay:(j*50)/,ease:punchgs.Power2.easeInOut}),0);
							...
							mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
											...
											{rotationX:0,opacity:1,top:0,z:0, scale:1,rotationY:0, delay:(j*50)/,ease:punchgs.Power2.easeInOut}),0);

							mtl.add(punchgs.TweenLite.to(ss,0.1,{opacity:1,force3D:"auto",delay:(j*50)/+masterspeed/}),0);
						...
						actsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
											...
											{opacity:1,rotationX:40,top:0, z:-600, left:ofx, force3D:"auto",scale:0.8,rotationY:rot, delay:(j*50)/,ease:punchgs.Power2.easeInOut}),0);
							mtl.add(punchgs.TweenLite.to(ss,0.1,{force3D:"auto",opacity:0,delay:(j*50)/+(masterspeed/ - (masterspeed/0))}),0);
						});
			}
		...
		var vimeoready_auto = function(player_id,autoplay) {
			...
			var updateHTML5Size = function(pc,container) {
					...
					if (windowAspect < mediaAspect) {
						// taller
						punchgs.TweenLite.to(pc,01,{width:windowH*mediaAspect,force3D:"auto",top:0,
												left:0-(windowH*mediaAspect-windowW)/2,
												height:windowH});

					} else {
						// wider
						punchgs.TweenLite.to(pc,01,{width:windowW,force3D:"auto",top:0-(windowW/mediaAspect-windowH)/2,
												left:0,
				...
				var getAnimSteps = function(data) {
						...
						jQuery.each(customarray,function(index,param) {
							...
							if (w=="speed") params.speed = parseInt(v,0)/;
							if (w=="start") params.start = parseInt(v,0)/;
						...
						allcaptions.each(function(i) {
								...
								if (handlecaption==0) {
									...
									if (nextcaption.hasClass("tp-videolayer") || nextcaption.find('iframe').length>0 || nextcaption.find('video').length>0 ) {
										...
										var frameID = "iframe"+Math.round(Math.random()*00+1),
																				...
																				events: {
																					...
																					'onReady': function(event) {
																						...
																						if (!is_mobile() && nextcaption.data('autoplay')==true || autoplaywason) {
																								nextcaption.data('timeUSD ay',setTimeout(function() {
																									event.target.playVideo();
													...
													if (html5vid.data('metaloaded')==1 || video.duration!=NaN) {
														...
														if (!html5vid.hasClass("HasListener")) {
															...
															if (nextcaption.data('autoplay')==true || autoplaywason==true) {
																...
																html5vid.data('timeUSD ay',setTimeout(function() {
									...
									// MDELAY AND MSPEED
									if (nextcaption.data('start') == undefined) nextcaption.data('start',);
									...
									var mdelay = nextcaption.data('start')/,
										mspeed = nextcaption.data('speed')/;
							...
							if (!internrecalled) {
									...
									if ((nextcaption.data('end')!=undefined) && (staticdirection==-1 || staticdirection==2)) {
										endMoveCaption(nextcaption,opt,nextcaption.data('end')/,frm,"frame99",xbw);
									} else {
							...
							if (staticdirection != 0 ) {
									...
									if (nextcaption.find('iframe').length>0) {
																	...
																	try {
																		...
																		clearTimeout(nextcaption.data('timeUSD ay'));
																	} catch(e) {}
									...
									if (nextcaption.find('video').length>0) {
													try{
														nextcaption.find('video').each(function(i) {
															...
															clearTimeout(html5vid.data('timeUSD ay'));
															var video = this;
															video.pause();
														})
													}catch(e) {}
			...
			if (opt.slideamount >1 && !(opt.stopAfterLoops==0 && opt.stopAtSlide==1) ) {
					...
					container.on('restarttimer',function() {
						...
						if ((opt.stopLoop=="on" && opt.next==opt.lastslidetoshow-1) || opt.noloopanymore == 1)
								...
								bt.css({visibility:"visible"});
								bt.data('tween').kill();
								bt.data('tween',punchgs.TweenLite.fromTo(bt,opt.delay/,{width:"0%"},{force3D:"auto",width:"100%",ease:punchgs.Linear.easeNone,onComplete:countDownNext,delay:1}));
...
**************************************************************************/
		...
		/******************************
			-	PARALLAX EFFECT	-
		********************************/
		var checkFoUSD rallax = function(container,opt) {
