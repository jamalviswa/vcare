	...
	*/
	...
	var p1i = punchgs.Power1.easeIn, 
		...
		transitionsArray = [ ['boxslide' , 0, 1, 10, 0,'box',false,null,0,p1o,p1o,500,6],
							 ...
							 ['fade', 11, 0, 1 ,300,'horizontal',true,null,11,p2io,p2io,,1],
							 ['crossfade', 11, 1, 1 ,300,'horizontal',true,null,11,p2io,p2io,,1],
							 ['fadethroughdark', 11, 2, 1 ,300,'horizontal',true,null,11,p2io,p2io,,1],
							 ['fadethroughlight', 11, 3, 1 ,300,'horizontal',true,null,11,p2io,p2io,,1],
							 ['fadethroughtransparent', 11, 4, 1 ,300,'horizontal',true,null,11,p2io,p2io,,1],
							 ['slideleft', 12, 0,1,0,'horizontal',true,true,12,p3io,p3io,,1],
							 ['slideup', 13, 0,1,0,'horizontal',true,true,13,p3io,p3io,,1],
							 ['slidedown', 14, 0,1,0,'horizontal',true,true,14,p3io,p3io,,1],
							 ['slideright', 15, 0,1,0,'horizontal',true,true,15,p3io,p3io,,1],
							 ['slideoverleft', 12, 7,1,0,'horizontal',true,true,12,p3io,p3io,,1],
							 ['slideoverup', 13, 7,1,0,'horizontal',true,true,13,p3io,p3io,,1],
							 ['slideoverdown', 14, 7,1,0,'horizontal',true,true,14,p3io,p3io,,1],
							 ['slideoverright', 15, 7,1,0,'horizontal',true,true,15,p3io,p3io,,1],
							 ['slideremoveleft', 12, 8,1,0,'horizontal',true,true,12,p3io,p3io,,1],
							 ['slideremoveup', 13, 8,1,0,'horizontal',true,true,13,p3io,p3io,,1],
							 ['slideremovedown', 14, 8,1,0,'horizontal',true,true,14,p3io,p3io,,1],
							 ['slideremoveright', 15, 8,1,0,'horizontal',true,true,15,p3io,p3io,,1],
							 ['papercut', 16, 0,0,600,'',null,null,16,p3io,p3io,,2],
							 ...
							 ['fadefromright', 12, 1,1,0,'horizontal',true,true,28,p2io,p2io,,1],
							 ['fadefromleft', 15, 1,1,0,'horizontal',true,true,29,p2io,p2io,,1],
							 ['fadefromtop', 14, 1,1,0,'horizontal',true,true,30,p2io,p2io,,1],
							 ['fadefrombottom', 13, 1,1,0,'horizontal',true,true,31,p2io,p2io,,1],
							 ['fadetoleftfadefromright', 12, 2,1,0,'horizontal',true,true,32,p2io,p2io,,1],
							 ['fadetorightfadefromleft', 15, 2,1,0,'horizontal',true,true,33,p2io,p2io,,1],
							 ['fadetobottomfadefromtop', 14, 2,1,0,'horizontal',true,true,34,p2io,p2io,,1],
							 ['fadetotopfadefrombottom', 13, 2,1,0,'horizontal',true,true,35,p2io,p2io,,1],							 
							 ...
							 ['scaledownfromright', 12, 4,1,0,'horizontal',true,true,40,p2io,p2i,,1],
							 ['scaledownfromleft', 15, 4,1,0,'horizontal',true,true,41,p2io,p2i,,1],
							 ['scaledownfromtop', 14, 4,1,0,'horizontal',true,true,42,p2io,p2i,,1],
							 ['scaledownfrombottom', 13, 4,1,0,'horizontal',true,true,43,p2io,p2i,,1],
							 ['zoomout', 13, 5,1,0,'horizontal',true,true,44,p2io,p2i,,1],
							 ['zoomin', 13, 6,1,0,'horizontal',true,true,45,p2io,p2i,,1],
							 ['slidingoverlayup', 27, 0,1,0,'horizontal',true,true,47,p1io,p1o,,1],
							 ['slidingoverlaydown', 28, 0,1,0,'horizontal',true,true,48,p1io,p1o,,1],
							 ['slidingoverlayright', 30, 0,1,0,'horizontal',true,true,49,p1io,p1o,,1],
							 ['slidingoverlayleft', 29, 0,1,0,'horizontal',true,true,50,p1io,p1o,,1],
							 ...
							 ['notransition',26,0,1,0,'horizontal',true,null,46,p2io,p2i,,1],
...
var animateSlideIntern = function(nexttrans, comingtransition, container,  opt, nextli, actli, nextsh, actsh,  mtl) {
	...
	masterspeed = masterspeed==="default" ? STA[11] : masterspeed==="random" ? Math.round(Math.random()*+300) : masterspeed!=undefined ? parseInt(masterspeed,0) : STA[11];
	...
	if (nexttrans==1) {
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.from(ss,rand/,
								{autoAlpha:0, force3D:"auto",rotation:opt.rotate,ease:ei}),rand2/);
				});
	}
	...
	if (nexttrans==2) {
				...
				actsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.to(ss,masterspeed/,{left:opt.slotw,ease:ei, force3D:"auto",rotation:(0-opt.rotate)}),0);
					mtl.add(subtl,0);
				});
				...
				nextsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.from(ss,masterspeed/,{left:0-opt.slotw,ease:ei, force3D:"auto",rotation:opt.rotate}),0);
					mtl.add(subtl,0);
				});
	}
	...
	if (nexttrans==3) {
				...
				actsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.to(ss,masterspeed/,{top:opt.sloth,ease:ei,rotation:opt.rotate,force3D:"auto",transformPerspective:600}),0);
					mtl.add(subtl,0);
				...
				nextsh.find('.slotslide').each(function() {
					var ss=jQuery(this);
					subtl.add(punchgs.TweenLite.from(ss,masterspeed/,{top:0-opt.sloth,rotation:opt.rotate,ease:eo,force3D:"auto",transformPerspective:600}),0);
					mtl.add(subtl,0);
				});
	}
	...
	if (nexttrans==6) {
				...
				actsh.find('.slotslide').each(function(i) {
					...
					subtl.add(punchgs.TweenLite.to(ss,(masterspeed+tempo)/,{top:0+opt.height,opacity:1,force3D:"auto",rotation:opt.rotate,ease:ei}),0);
					mtl.add(subtl,0);
				});
				...
				nextsh.find('.slotslide').each(function(i) {
					...
					subtl.add(punchgs.TweenLite.from(ss,(masterspeed+tempo)/,
	...
	if (nexttrans==7) {
				...
				actsh.find('.slotslide').each(function() {
					...
					subtl.add(punchgs.TweenLite.to(ss,masterspeed/,{
				...
				nextsh.find('.slotslide').each(function(i) {
					...
					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
	...
	if (nexttrans==9 || nexttrans==10) {
				...
				nextsh.find('.slotslide').each(function(i) {
					var ss=jQuery(this);
					ssamount++;
					mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,{autoAlpha:0,force3D:"auto",transformPerspective:600},
																		 {autoAlpha:1,ease:ei,delay:(i*5)/}),0);
	...
	if (nexttrans==27||nexttrans==28||nexttrans==29||nexttrans==30) {
		...
		mtl.add(punchgs.TweenLite.fromTo(actsh,masterspeed/,fa,ta),0);						
		mtl.add(punchgs.TweenLite.fromTo(nextsh.find('.defaultimg'),masterspeed/,fb,tb),masterspeed/);				
		mtl.add(punchgs.TweenLite.fromTo(slot,masterspeed/,fc,tc),0);	
		mtl.add(punchgs.TweenLite.fromTo(slot.find('.slotslide div'),masterspeed/,fd,td),0);			
	}
	...
	if (nexttrans==11) {
			...
			if (specials>4) specials = 0;
				...
				var ssamount=0,
					bgcol = specials == 2 ? "000" : specials == 3 ? "#ffffff" : "transparent";
												
				switch (specials) {
					case 0: //FADE 						
						mtl.add(punchgs.TweenLite.fromTo(nextsh,masterspeed/,{autoAlpha:0},{autoAlpha:1,force3D:"auto",ease:ei}),0);																
					break;

					case 1: // CROSSFADE						
						mtl.add(punchgs.TweenLite.fromTo(nextsh,masterspeed/,{autoAlpha:0},{autoAlpha:1,force3D:"auto",ease:ei}),0);				
						mtl.add(punchgs.TweenLite.fromTo(actsh,masterspeed/,{autoAlpha:1},{autoAlpha:0,force3D:"auto",ease:ei}),0);														
					break;
					...
					case 4:
						...
						mtl.add(punchgs.TweenLite.to(actsh,masterspeed/,{autoAlpha:0,force3D:"auto",ease:ei}),0);
						mtl.add(punchgs.TweenLite.fromTo(nextsh,masterspeed/,{autoAlpha:0},{autoAlpha:1,force3D:"auto",ease:ei}),masterspeed/);																
					break;
	...
	if (nexttrans==16) {						// PAPERCUT
			...
			if (actli.html()!=null)
				mtl.add(punchgs.TweenLite.fromTo(nextli,(masterspeed-200)/,
	...
	if (nexttrans==19 || nexttrans==22) {								// IN CUBE
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
									...
									{left:0,rotationY:0,top:0,z:0, scale:1,force3D:"auto",rotationX:0, delay:(j*50)/,ease:ei}),0);
					subtl.add(punchgs.TweenLite.to(ss,0.1,{autoAlpha:1,delay:(j*50)/}),0);
					mtl.add(subtl);
				});
				...
				actsh.find('.slotslide').each(function(j) {
					...
					subtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
									...
									{autoAlpha:1,rotationY:opt.rotate,top:0,z:10, scale:1,rotationX:rot, delay:(j*50)/,force3D:"auto",ease:eo}),0);
	...
	if (nexttrans==20 ) {								// FLYIN
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,
	...
	if (nexttrans==21 || nexttrans==25) {								// TURNOFF
				...
				nextsh.find('.slotslide').each(function(j) {
					...
					mtl.add(punchgs.TweenLite.fromTo(ss,(ms2*2)/,
									...
									{left:0,rotationX:0,top:0,z:0, autoAlpha:1,scale:1,rotationY:0,force3D:"auto",delay:ms2/, ease:ei}),0);
				});
	...
	if (nexttrans==23 || nexttrans == 24) {								// cube-horizontal - inboxhorizontal
		...
		actsh.find('.slotslide').each(function(j) {
			...
			if (nexttrans==23) mtl.add(punchgs.TweenLite.fromTo(ss,masterspeed/,{autoAlpha:1},{autoAlpha:0,delay:(j*50)/500 + masterspeed/,ease:eo}),0);
