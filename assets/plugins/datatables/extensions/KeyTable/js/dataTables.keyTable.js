...
KeyTable = function ( oInit )
{
	...
	/*
	 * Variable: block
	 * PuUSD se:  Flag whether or not KeyTable events should be processed
	...
	/*
	 * Variable: event
	 * PuUSD se:  Container for all event application methods
	 * Scope:    KeyTable - public
	 ...
	 * PuUSD se:  Get the currently focused cell's position
	 ...
	 * PuUSD se:  Get the currently focused cell's data (innerHTML)
	 ...
	 * PuUSD se:  Get the currently focused cell
	 ...
	 * PuUSD se:  Set the position of the focused cell
	 * Returns:  -
	...
	/*
	 * Function: fnBlur
	 * PuUSD se:  Blur the current focus
	 * Returns:  -
	 * Inputs:   -
	 */
	...
	/*
	 * Variable: _nBody
	 * PuUSD se:  Body node of the table - cached for renference
	 ...
	 * PuUSD se:  X and Y coords of the old elemet that was focused on
	 * Scope:    KeyTable - private
	 */
	var _iOldX = null;
	var _iOldY = null;
	...
	/*
	 * Variable: _that
	 * PuUSD se:  Scope saving for 'this' after a jQuery event
	 * Scope:    KeyTable - private
	 */
	var _that = null;
	 ...
	 * PuUSD se:  Class that should be used for focusing on a cell
	 * Scope:    KeyTable - private
	 */
	 ...
	 * PuUSD se:  Flag for should KeyTable capture key events or not
	 * Scope:    KeyTable - private
	 */
	...
	/*
	 * Variable: _oaoEvents
	 * PuUSD se:  Event cache object, one array for each supported event for speed of searching
	 * Scope:    KeyTable - private
	 */
	var _oaoEvents = {
		"action": [],
	 ...
	 * PuUSD se:  DataTables settings object for if we are actually using a 
	 *           DataTables table
	 * Scope:    KeyTable - private
	 */
	 ...
	 * PuUSD se:  Create a function (with closure for sKey) event addition API
	...
	function _fnEventAddTemplate( sKey )
	{
		/*
		 * Function: -
		 * PuUSD se:  API function for adding event to cache
		 * Returns:  -
	 ...
	 * PuUSD se:  Create a function (with closure for sKey) event removal API
	 * Returns:  function: - template function
	 * Inputs:   string:sKey - type of event to detect
	 */
	function _fnEventRemoveTemplate( sKey )
	{
		/*
		 * Function: -
		 * PuUSD se:  API function for removing event from cache
	 ...
	 * PuUSD se:  Add an event to the internal cache
	 * Returns:  -
	 ...
	 * PuUSD se:  Remove an event from the event cache
	 ...
	 * PuUSD se:  Look thought the events cache and fire off the event of interest
	 ...
	 * PuUSD se:  Set focus on a node, and remove from an old node if needed
	 * Returns:  -
	...
	/*
	 * Function: _fnBlur
	 * PuUSD se:  Blur focus from the whole table
	 * Returns:  -
	 * Inputs:   -
	 */
	function _fnBlur()
	 ...
	 * PuUSD se:  Remove focus from a cell and fire any blur events which are attached
	 * Returns:  -
	...
	/*
	 * Function: _fnClick
	 * PuUSD se:  Focus on the element that has been clicked on by the user
	 * Returns:  -
	...
	/*
	 * Function: _fnKey
	 * PuUSD se:  Deal with a key events, be it moving the focus or return etc.
	 ...
	 * PuUSD se:  Start capturing key events for this table
	 * Returns:  -
	 * Inputs:   -
	 */
	function _fnCaptureKeys( )
	 ...
	 * PuUSD se:  Stop capturing key events for this table
	 * Returns:  -
	 * Inputs:   -
	 */
	function _fnReleaseKeys( )
	 ...
	 * PuUSD se:  Calulate the target TD cell from x and y coordinates
	 ...
	 * PuUSD se:  Calculate the x and y position in a table from a TD cell
	 ...
	 * PuUSD se:  Set the vertical scrolling position
	 * Returns:  -
	 ...
	 * PuUSD se:  Set the horizontal scrolling position
	 * Returns:  -
	...
	/*
	 * Function: _fnGetPos
	 * PuUSD se:  Get the position of an object on the rendered page
	 ...
	 * PuUSD se:  Get the coords. of a cell from the DataTables internal information
	...
	/*
	 * Function: _fnInit
	 * PuUSD se:  Initialise the KeyTable
	 * Returns:  -
