...
(c=e.split(".")),h=c.length)for(b=a;b&&h--;)f=c.shift(),b=b[f]}catch(g){}return b},getXmlData:function(d,e,b){var f="string"===typeof e?e.match(/^(.*)\[(\w+)\]$/):null;if("function"===typeof e)return e(d);if(f&&f[2])return f[1]?a(f[1],d).attr(f[2]):a(d).attr(f[2]);d=a(e,d);return b?d:0<d.length?a(d).text():void 0},cellWidth:function(){var d=a("<div class='ui-jqgrid' style='left:0px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),
...
rownumbers:!1,pageUSD s:"center",recordpos:"right",footerrow:!1,userDataOnFooter:!1,hoverrows:!0,altclass:"ui-priority-secondary",viewsortcols:[!1,"vertical",!0],resizeclass:"",autoencode:!1,remapColumns:[],ajaxGridOptions:{},direction:"ltr",toppager:!1,headertitles:!1,scrollTimeout:40,data:[],_index:{},grouping:!1,groupingView:{groupField:[],groupOrder:[],groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:!1,sortitems:[],sortnames:[],summary:[],summaryval:[],plusicon:"ui-icon-circlesmall-plus",
...
0:0);H=Math.max(H,a?a.rowpos||0:0)});a(W).append(Y);A=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*M+"'></td></tr>");A[0].USD 0;a(Y).append(A);A=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*M+"'>"+d[n.p.id].topinfo+"</td></tr>");A[0].USD 0;a(Y).append(A);var B=(A="rtl"===n.p.direction?!0:!1)?"nData":"pData",D=A?"pData":"nData";c(e,n,Y,M);var B="<a id='"+B+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(A?D+B:B+D)+"</td><td class='EditButton'>"+aa+S+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[n.p.id].bottominfo+"</td></tr>"),v=v+"</tbody></table>";if(0<H){var ba=[];a.each(a(Y)[0].rows,function(a,b){ba[a]=b});ba.sort(function(a,b){return a.USD b.USD 1:a.USD b.USD -1:0});a.each(ba,function(b,c){a("tbody",Y).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(s);var ga=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,ga=!0);v=a("<div></div>").append(W).append(v);a.jgrid.createModal(w,
...
l+1,s=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(u);u[0].USD r}h=a(e).find("tr[rowpos="+r+"]");0===h.length&&(h=a("<tr "+n+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(w),a(e).append(h),h[0].USD r);a("td:eq("+(s-2)+")",h[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:c.label)+"</b>");a("td:eq("+(s-1)+")",h[0]).append("<span>"+m+"</span>").attr("id","v_"+g);
z&&a("td:eq("+(s-1)+") span",h[0]).css({"text-align":"right",width:v+"px"});p[l]=b;l++}});0<l&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].USD l+99,a(e).append(c));return p}function h(b,c){var d,e,f=0,g,k;if(k=a(c).jqGrid("getInd",b,!0))a("td",k).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
