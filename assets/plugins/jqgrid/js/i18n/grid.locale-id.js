...
$.extend($.jgrid,{
	...
	del : {
		caption: "Hapus",
		msg: "Hapus data teUSD lih?",
		bSubmit: "Hapus",
		bCancel: "Batalkan"
	},
	nav : {
		edittext: "",
		edittitle: "Sunting data teUSD lih",
		addtext:"",
		addtitle: "Tambah baris baru",
		deltext: "",
		deltitle: "Hapus baris teUSD lih",
		searchtext: "",
		...
		viewtext: "",
		viewtitle: "Tampilkan baris teUSD lih"
	},
	col : {
		caption: "Pilih Kolom",
		bSubmit: "Ok",
	...
	formatter : {
		...
		currency : {decimalSeparator:",", thousandsSeparator: ".", decimalPlaces: 2, prefix: "USD  ", suffix:"", defaultValue: '0'},
		date : {
			dayNames:   [
