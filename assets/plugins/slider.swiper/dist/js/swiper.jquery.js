    ...
    window.Swiper = function (container, params) {
        ...
        s.onTouchEnd = function (e) {
            ...
            if (s.params.freeMode) {
                ...
                if (s.params.freeModeMomentum) {
                    ...
                    velocities.length = 0;
                    var momentumDuration =  * s.params.freeModeMomentumRatio;
        ...
        s.initObservers = function () {
            if (s.params.observeParents) {
                var containeUSD rents = s.container.parents();
                for (var i = 0; i < containeUSD rents.length; i++) {
                    initObserver(containeUSD rents[i]);
                }
            }
