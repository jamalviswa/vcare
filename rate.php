...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<div style="font-family:Segoe UI;color:grey:font-size 13px;margin:10px;"><br><br><br><center>
Berikan Rating untuk Driver Anda, <br>Rating Memberikan motivasi kepada Driver <br>agar lebih semangat dalam melayani klien. Klik Bintang ...</center>
</div>
<?php
ob_start();
...
<div class="container">
  ...
  ?>
    ...
    <span id="ratingSaved"></span></center>
  </div>
</div><center><button onclick="history.back()" style="width:200px;font-size:14px;height:auto;padding-bottom:20px;"class="ladda-button"data-color="green" >Selesai</button>
</center>